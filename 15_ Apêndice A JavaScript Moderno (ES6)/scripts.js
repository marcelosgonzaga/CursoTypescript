...
const avariableUsers = users.filter((user) => user.available)
const notavailablerUsers = users.filter((user) => !user.available)

console.log(avariableUsers)
console.log(notavailablerUsers)

// 4 map

const products = [
  {name: 'Camisa', price: 10.99, category: 'Roupas'},
  {name: 'Fritadeira Elétrica', price: 500.99, category: 'Eletro'},
  {name: 'Fogão', price: 900.00, category: 'Eletro'},
...
console.log(`O nome do usuário é ${userName} e a idade ${age} anos.`)
console.log('O nome do usuário é ' + userName + ' e a idade ' + age + ' anos.')
...
const shirt = new Product('Camisa goa v', 50)
